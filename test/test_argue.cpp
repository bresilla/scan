...
TEST_SUITE("Argue Basic Parsing") {
    ...
    TEST_CASE("Parse positional argument") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("name").positional().required().value_of(name));
    ...
    TEST_CASE("Parse short option") {
        int count = 0;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("count").short_name('c').value_of(count));
    ...
    TEST_CASE("Parse long option") {
        int count = 0;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("count").long_name("count").value_of(count));
    ...
    TEST_CASE("Parse long option with equals syntax") {
        std::string value;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("opt").long_name("option").value_of(value));
    ...
    TEST_CASE("Parse combined short options") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("a").short_name('a').flag(a))
            .arg(argue::Arg("b").short_name('b').flag(b))
            .arg(argue::Arg("c").short_name('c').flag(c));
    ...
    TEST_CASE("Parse short option with attached value") {
        int num = 0;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("num").short_name('n').value_of(num));
    ...
    TEST_CASE("Parse flag") {
        bool verbose = false;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("verbose").short_name('v').long_name("verbose").flag(verbose));
    ...
    TEST_CASE("Parse counting flag") {
        int verbosity = 0;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("verbose").short_name('v').count(verbosity));
    ...
    TEST_CASE("Parse multiple values into vector") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("files").short_name('f').value_of(files).takes_multiple());
    ...
    TEST_CASE("Parse with -- separator") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("name").positional().value_of(name))
            .arg(argue::Arg("rest").positional().value_of(rest).takes_multiple());
...
TEST_SUITE("Argue Default Values") {
    ...
    TEST_CASE("Apply default string value") {
        std::string value;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("opt").long_name("opt").value_of(value).default_value("default"));
    ...
    TEST_CASE("Apply default int value") {
        int value = 0;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("num").long_name("num").value_of(value).default_value("42"));
    ...
    TEST_CASE("Range validator accepts valid value") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("port")
                .long_name("port")
                .value_of(port)
                .validate(argue::validators::range(1, 65535)));
    ...
    TEST_CASE("Positive validator") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("num")
                .long_name("num")
                .value_of(num)
                .validate(argue::validators::positive<int>()));
    ...
    TEST_CASE("Non-empty validator") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("val")
                .long_name("val")
                .value_of(value)
                .validate(argue::validators::non_empty()));
    ...
    TEST_CASE("Regex validator") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("val")
                .long_name("val")
                .value_of(value)
                .validate(argue::validators::regex("^[a-z]+$", "must be lowercase letters only")));
...
TEST_SUITE("Argue Help and Version") {
    ...
    TEST_CASE("Short help flag works") {
        auto cmd = argue::Command("test").about("Test app");
    ...
    TEST_CASE("Version flag returns success with message") {
        auto cmd = argue::Command("test").version("2.0.0");
...
TEST_SUITE("Argue Subcommands") {
    ...
    TEST_CASE("Parse subcommand") {
        std::string add_name;
        auto add = argue::Command("add")
            .about("Add an item")
            .arg(argue::Arg("name").positional().required().value_of(add_name));
    ...
    TEST_CASE("Subcommand alias works") {
        std::string name;
        auto remove = argue::Command("remove")
            .alias("rm")
            .arg(argue::Arg("name").positional().required().value_of(name));
    ...
    TEST_CASE("Required subcommand missing") {
        auto add = argue::Command("add").about("Add item");
...
TEST_SUITE("Argue Error Handling") {
    ...
    TEST_CASE("Missing value error") {
        std::string value;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("opt").long_name("opt").value_of(value));
    ...
    TEST_CASE("Conflicting arguments") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("opt1").long_name("opt1").flag(opt1).conflicts_with("opt2"))
            .arg(argue::Arg("opt2").long_name("opt2").flag(opt2));
    ...
    TEST_CASE("Required dependency missing") {
        ...
        std::string log_file;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("debug").long_name("debug").flag(debug).requires_arg("log-file"))
            .arg(argue::Arg("log-file").long_name("log-file").value_of(log_file));
...
TEST_SUITE("Argue Matches API") {
    ...
    TEST_CASE("contains() checks argument presence") {
        bool flag = false;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("flag").short_name('f').flag(flag));
    ...
    TEST_CASE("occurrences() counts argument usage") {
        int verbosity = 0;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("v").short_name('v').count(verbosity));
    ...
    TEST_CASE("get_one() returns single value") {
        std::string val;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("opt").long_name("opt").value_of(val));
    ...
    TEST_CASE("get_many() returns all values") {
        ...
        auto cmd = argue::Command("test")
            .arg(argue::Arg("opt").short_name('o').value_of(vals).takes_multiple());
    ...
    TEST_CASE("get<T>() converts value") {
        int num = 0;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("num").long_name("num").value_of(num));
    ...
    TEST_CASE("get_or() returns default if missing") {
        auto cmd = argue::Command("test")
            .arg(argue::Arg("opt").long_name("opt"));
...
TEST_SUITE("Argue Type Conversion") {
    ...
    TEST_CASE("Convert to vector<int>") {
        std::vector<int> vals;
        auto cmd = argue::Command("test")
            .arg(argue::Arg("n").short_name('n').value_of(vals).takes_multiple());
